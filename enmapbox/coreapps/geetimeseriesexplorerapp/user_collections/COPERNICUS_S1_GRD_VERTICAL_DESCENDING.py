...
# Title: Sentinel-1 Descending orbits - unfiltered
# ID: COPERNICUS_S1_GRD
#
# This collection returns unfiltered Sentinel-1 Images in descending orbits.
...
band_names = ee.List(['VH','VV','VHg0','VVg0','Ratio VVg0/VHg0','VV_dev','VH_dev','VHg0_dev','VVg0_dev','Ratio_dev'])
