...
class CmykColorRasterRendererDialog(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.mBand4.bandChanged.connect(self.onLiveUpdate)
    ...
    def currentRenderer(self) -> Optional[CmykColorRasterRenderer]:
        layer = self.currentLayer()
        if layer is None:
            return None
        ...
        band4 = self.mBand4.currentBand()

        if -1 in [band1, band2, band3, band4]:
            return None
