...
helpAlg = Help(text='Fits a Quantile Transformer (transforms features using quantiles information). See also {}',
...
helpCode = Help(text='Scikit-learn python code. See {} for information on different parameters.',
                links=[Link('http://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.quantile_transform.html',
                            'quantile_transform')
                       ])