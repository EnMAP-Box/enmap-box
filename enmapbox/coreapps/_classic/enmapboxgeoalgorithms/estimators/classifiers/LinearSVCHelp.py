...
helpAlg = Help(text = 'Fits a linear Support Vector Classification. Input data will be scaled and grid search is used for model selection.')
...
helpCode = Help(
    ...
    links=[Link('http://scikit-learn.org/stable/modules/generated/sklearn.svm.LinearSVC.html', 'LinearSVC'),
