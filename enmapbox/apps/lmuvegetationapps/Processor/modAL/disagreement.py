...
def edb(regressor: BaseEstimator, X: modALinput,
                                       n_instances: int = 1, **predict_kwargs) -> np.ndarray:
    """
    :param regressor:
    :param X:
    :param n_instances:
    ...
    max_dist = multi_argmax(distances, n_instances=n_instances)
    # print(max_dist)
...
def ebd_insitu(regressor: BaseEstimator, X: modALinput, X_val: modALinput,
                                       n_instances: int = 1, **predict_kwargs) -> np.ndarray:
    """
    :param regressor:
    :param X:
    ...
    distances = euclidean_distances(X, X_val, squared=True)
    max_dist = multi_argmax(distances, n_instances=n_instances)
    # print(max_dist)
    # print(distances.shape)
    print(max_dist)
...
def pool_of_regressors(regressor: BaseEstimator, X: modALinput,
                       n_instances: int = 1, **predict_kwargs) -> np.ndarray:
    '''
    :param regressor:
    :param X:
