...
class OCPFTProcessingAlgorithm(QgsProcessingAlgorithm):
    ...
    SENSORS_USER = ['EnMAP (Environmental Mapping and Analysis Program, Germany)',
                    'OLCI (Ocean and Land Colour Instrument, Europe)',
                    'MSI (Medium Resolution Imaging Spectrometer, Europe)',
                    'DESIS (DLR Earth Sensing Imaging Spectrometer, Germany)']
    ...
    def shortHelpString(self):
        ...
        html = (
            ...
            'between PFT specific Chl-a to total Chl-as obtained from a large HPLC '
            'based phytoplankton pigment data set. '
            ...
            '[<a href="https://www.frontiersin.org/articles/10.3389/fmars.2017.00203/full">'
            'using Losa et al.,2017</a>; '
            '<a href="https://www.awi.de/en/science/climate-sciences/physical-oceanography/'
            'main-research-focus/ocean-optics/publications/non-peer-reviewed-articles.html#c33874"> '
            'updated as in Alvarado et al., 2022</a>]. </p>'
            ''
            '<h3>Input</h3>'
            '<p>The level-2 Chl-a data in NETCDF4 (Standard Polymer output) '
            'and GeoTiff formats (EnPT-ACWater output). </p>'
            ''
            '<h3>Sensor</h3>'
            ...
            '<p>'
            'The EnMAP Level-2 Chl-a is generated by EnPT and uses the Polymer algorithm for atmospheric correction '
            'over water. Polymer is a spectral matching algorithm in which atmospheric and '
            'oceanic signals are obtained '
            'simultaneously using the fully available visible spectrum. The algorithm was developed by '
            '<a href="www.hygeos.com"> Hygeos</a>; it is available as a python package and it has been largely '
