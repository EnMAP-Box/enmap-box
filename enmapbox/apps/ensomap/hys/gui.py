...
class CSV(QWidget):
    ...
    def __init__(self, dname, widParent, widButID, widLabID, csv_data, parent=None):
        ...
        self.gui.widget_radio_button('Comma', group=groupDelimiter, ID='but_com', default=True,
                                     action=self.set_delimiter)
        self.gui.widget_column_close()
        self.gui.widget_group_box_close()
        self.gui.widget_column_close()
        self.gui.widget_column()
        ...
        self.gui.widget_radio_button('Geographical (lat/lon, UTM, etc.)', group=groupCoordinates, ID='but_geo',
                                     default=True, action=self.set_coordinates)
        ...
        if self.csv_data.rows != []:
            ...
            if self.csv_data.delimiter == '\t':
                but_delim = [True, False, False, False]
            elif self.csv_data.delimiter == ';':
                but_delim = [False, True, False, False]
            elif self.csv_data.delimiter == ':':
                but_delim = [False, False, True, False]
            else:
                but_delim = [False, False, False, True]
            ...
            if self.csv_data.coordinates == 1:
                but_coord = [True, False]
            else:
                but_coord = [False, True]
