...
from enmapbox.apps.SpecDeepMap.core_Tester4 import process_images_from_csv
...
class DL_Tester(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
       ...
       # self.addParameter(QgsProcessingParameterFolderDestination(
        ...
        self.addParameter(QgsProcessingParameterFolderDestination(
            name=self.P_folder_preds, description='Save and export prediction images to folder', optional=True ,createByDefault=False))
