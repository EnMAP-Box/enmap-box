...
from enmapbox.apps.SpecDeepMap.core_deep_learning_trainer_develop_MicaSense import dl_train
...
class DL_Trainer(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        ...
        html = '' \
               ...
               '<p>The main architecture for the deep learning model can be defined with this variable. Options are Unet, Unet++ and DeeplabV3+, these models need to be combine with a specified backbone. Also 2d-Justo-Unet_simple can be used as architecture, but this architecture cant be used with backbone.</p>' \
