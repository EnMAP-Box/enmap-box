...
class CustomDataset(Dataset):
    ...
    def __init__(
        ...
        self.remap = np.vectorize(self.reclass_look_up_table.get)
...
class MyModel(L.LightningModule):
    def __init__(
        ...
        self.reverse_mapping = np.vectorize(self.reverse_look_up_table.get)
    ...
    def predict(self, image: torch.Tensor):
        ...
        pred3 = self.reverse_mapping(pred2)
...
def dl_train(
    ...
    model = MyModel(
        ...
        hparams={
            ...
            "scaler": scaler_value,
            "look_up_table": forward_mapping,
            "reverse_look_up_table": reverse_mapping,
    ...
    if checkpoint_path == True:
        ...
        model = MyModel.load_from_checkpoint(checkpoint_path, train_data=train_data, val_data=val_data,
                                             hparams={'in_channels': in_channels,
                                                      ...
                                                      "scaler": scaler_value,
                                                      "look_up_table": forward_mapping,
                                                      "reverse_look_up_tabe": reverse_mapping,
                                                      "class_values": cls_values},
