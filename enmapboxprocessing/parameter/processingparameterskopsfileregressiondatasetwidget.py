...
class ProcessingParameterSkopsFileRegressionDatasetWidgetWrapper(QgsAbstractProcessingParameterWidgetWrapper):
    ...
    def createWidget(self):
        self._widget = ProcessingParameterSkopsFileRegressionDatasetWidget()
        return self._widget
...
class ProcessingParameterSkopsFileRegressionDatasetWidgetFactory(QgsProcessingParameterWidgetFactoryInterface):
    WIDGET_TYPE = 'enmapbox:ProcessingParameterSkopsFileRegressionDatasetWidget'
    _wrappers = []
    ...
    def createWidgetWrapper(self, parameter, widget_type):
        wrapper = ProcessingParameterSkopsFileRegressionDatasetWidgetWrapper(parameter, widget_type)
