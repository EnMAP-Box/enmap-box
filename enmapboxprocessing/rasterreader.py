...
class RasterReader(object):
    ...
    def arrayFromPixelOffsetAndSize(
        ...
        if self.crs().isValid():
            ...
            p1 = QgsPointXY(self.provider.transformCoordinates(p1_, QgsRasterDataProvider.TransformType.TransformImageToLayer))
            p2 = QgsPointXY(self.provider.transformCoordinates(p2_, QgsRasterDataProvider.TransformType.TransformImageToLayer))
