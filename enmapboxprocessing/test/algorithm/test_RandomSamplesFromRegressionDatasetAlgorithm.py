...
from enmapboxtestdata import (regressorDumpMultiTargetPkl, regressorDumpSingleTargetPkl)
...
class TestRandomSamplesFromRegressionDatasetAlgorithm(TestCase):
    ...
    def test_multitarget(self):
        ...
        alg.initAlgorithm()
        parameters = {
            alg.P_DATASET: regressorDumpMultiTargetPkl,  # 6 targets, 2559 samples, 177 features
            alg.P_BINS: 10,
            alg.P_N: 1,
            alg.P_SEED: 42,
