...
class SpatialMorphologicalGreyErosionAlgorithm(SpatialFilterFunctionAlgorithmBase):
    ...
    def helpParameterCode(self) -> str:
        links = ', '.join([
            self.htmlLink('https://docs.scipy.org/doc/scipy/reference/generated/scipy.ndimage.grey_erosion.html',
                          'grey_erosion'),
            self.htmlLink(
    ...
    def code(cls):
        ...
        return lambda array: grey_erosion(array, structure=structure)
