...
engeomap_gamesberg_field_library_color_mod_csv = (root / 'engeomap' / 'gamesberg_field_library_color_mod.csv').as_posix()
enmap_uncompressed_tif = (root / 'enmap_uncompressed.tif').as_posix()
force_1984_2021_060_319_HL_TSA_LNDLG_NDV_TSI_tif = (root / 'force' / '1984-2021_060-319_HL_TSA_LNDLG_NDV_TSI.tif').as_posix()
...
regressor_pkl = (root / 'regressor.pkl').as_posix()
regressor_multitarget_pkl = (root / 'regressor_multitarget.pkl').as_posix()
regressor_singletarget_pkl = (root / 'regressor_singletarget.pkl').as_posix()
