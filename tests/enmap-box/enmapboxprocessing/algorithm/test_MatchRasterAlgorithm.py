    ...
    def test(self):
        ...
        with open(poi, 'w') as file:
            file.write(
                ...
                '    "features": [\n'
                '        { "type": "Feature", "properties": { "fid": 32, "level_1": "vegetation", "level_2": "low vegetation", "date": "2027-01-01T12:00:00" }, "geometry": { "type": "Point", "coordinates": [ 370775.181699999608099, 5804816.683299999684095 ] } },\n'
                '        { "type": "Feature", "properties": { "fid": 73, "level_1": "vegetation", "level_2": "tree", "date": "2027-01-01T12:00:00" }, "geometry": { "type": "Point", "coordinates": [ 365009.064299999736249, 5806845.435200000181794 ] } }\n'
                '    ]\n'
                '}'
            )
