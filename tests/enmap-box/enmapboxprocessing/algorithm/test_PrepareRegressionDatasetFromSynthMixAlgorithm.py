...
class TestFitClassifierAlgorithm(TestCase):
    ...
    def test(self):
        ...
        for category in ClassifierDump.fromDict(Utils.modelLoad(classifierDumpSkops)).categories:
            filename = join(parameters[alg.P_OUTPUT_FOLDER], category.name + '.skops')
