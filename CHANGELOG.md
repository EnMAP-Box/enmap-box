...
* [API] support raster data reading with on-the-fly reprojection [#1005](https://github.com/EnMAP-Box/enmap-box/issues/1005)
...
* typeguard.TypeCheckError: argument "defaultFileExtension" (None) is not an instance of str [#1096](https://github.com/EnMAP-Box/enmap-box/issues/1096)
</details>
...
### Fixed Bugs
<details><summary>Show all (40)</summary>
