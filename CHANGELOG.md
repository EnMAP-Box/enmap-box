...
* typeguard.TypeCheckError: argument "maxValue" (None) is not an instance of
  int [#789](https://github.com/EnMAP-Box/enmap-box/issues/789)
...
* macOS: ImportError: cannot import name 'DMD_CREATIONFIELDDATASUBTYPES' from '
  osgeo.gdalconst' [#843](https://github.com/EnMAP-Box/enmap-box/issues/843)
...
* [Spectral Index Creator] add support for formulars with input bands given by center
...
* typeguard.TypeCheckError: mList is not an instance of
  PyQt5.QtWidgets.QListWidget [#398](https://github.com/EnMAP-Box/enmap-box/issues/398)
