...
* EnMAP-Box opens Tanager \*.h5 files and reads wavelength information from
...
* added support to visualize profiles from multiple vector layers
* added interactive legend that allows to hide single profiles
...
* fixed reading of wavelenght information in RasterReader
* fixed reading of sublayers
