...
#### Miscellaneous
* Missing Wavelength units" field in hdr: guessed in some cases, not in others [#25](https://github.com/EnMAP-Box/enmap-box/issues/25)
...
### Fixed Bugs
<details><summary>Show all (10)</summary>

* [QPS] latest pyqtgraph update introduces ModuleNotFoundError [#932](https://github.com/EnMAP-Box/enmap-box/issues/932)
* numpy.core._exceptions._ArrayMemoryError [#995](https://github.com/EnMAP-Box/enmap-box/issues/995)
* Error in yml file for conda environment [#1010](https://github.com/EnMAP-Box/enmap-box/issues/1010)
* fusion style: Spectral Library Viewer Profile Group checkboxes are hidden [#1027](https://github.com/EnMAP-Box/enmap-box/issues/1027)
